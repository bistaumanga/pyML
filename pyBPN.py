...
class ANN:
	...
	def bpCost(self, data, regLambda):
		''' Cost Function of the BackProp Net'''
		...
		for i in range(data.m):
			...
			for l in range(self.L - 2 , 0, -1):
				delta[l] = np.multiply(self.dh(z[l]), W[l][1:] * delta[l + 1])
